                ...
                <div class="row">
                    <div class="col-lg-12 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" placeholder="Enter Categories Name" class="form-control" id="productName" value="{{ old('name', $model->name ?? '') }}" required> <!-- Fill with existing value -->
                            @error('name')
